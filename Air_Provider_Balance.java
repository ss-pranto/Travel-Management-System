...
public class Air_Provider_Balance extends JFrame implements ActionListener{
	...
	public Air_Provider_Balance()
	{
		...
		Title_label.setForeground(Color.decode("#295982"));
				...
				String Balance ="";
		try{
			reader = new FileReader("All Text Files/balance_Air_Provider.txt");
