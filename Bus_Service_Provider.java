...
public class Bus_Service_Provider extends JFrame implements ActionListener{
	...
	public Bus_Service_Provider()
	{
		...
		JLabel Feature_label= new JLabel("Feature");
		...
		try
			{
				...
				else
				{
					String Str = R1C5.getText() + ","+ R2C5.getText()+ "," + R3C5.getText() + "," + R4C5.getText()+"," + R5C5.getText()+"," + R6C5.getText() + "\n";
						...
						FW= new FileWriter("All Text Files/V_Pricing_Bus_Service.txt");
