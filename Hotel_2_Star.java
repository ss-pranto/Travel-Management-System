...
public class Hotel_2_Star extends JFrame implements ActionListener{
	...
	public Hotel_2_Star()
	{
		...
		JLabel Title_label= new JLabel("2 STAR HOTEL PRICE");
		...
		try
			{
				...
				else
				{
					String Str = R1C5.getText() + "," + R2C5.getText() + "," + R3C5.getText() + "," + R4C5.getText() + "\n";
						...
						FW= new FileWriter("All Text Files/V_Pricing_H_2_star.txt");
