...
public class Hotel_3_Star extends JFrame implements ActionListener
{
	...
	public Hotel_3_Star()
	{
		...
		JLabel Title_label= new JLabel("3 STAR HOTEL PRICE");
		...
		try
			{
				...
				else
				{
					String Str = R1C5.getText() + "," + R2C5.getText() + "," + R3C5.getText() + "," + R4C5.getText() + "\n";
						...
						FW= new FileWriter("All Text Files/V_Pricing_H_3_star.txt");
