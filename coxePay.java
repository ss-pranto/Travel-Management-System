...
public class coxePay extends JFrame implements ActionListener{
	...
	private coxe coxe_obj;

    public coxe get_pack_obj(){
        return coxe_obj;
    }

    public coxePay(Login login_Obj,CustomerInfo CustomerInfo_obj,pPack pPack_obj,coxe coxe_obj){
        super("PAYMENT");
		
		this.login_Obj=login_Obj;
		this.CustomerInfo_obj=CustomerInfo_obj;
		this.pPack_obj=pPack_obj;
		this.coxe_obj=coxe_obj;
            ...
            if(rbt1.isSelected()==true){
                if(!nc.isEmpty()&&!cn.isEmpty()&&!vo.isEmpty()&&!cvv.isEmpty()){
                    ...
                    try{
                        ...
                        writer.write(email+","+"Cox's Bazar"+","+date+","+person+","+hotel+","+day+",2,"+room+","+vehicle+","+payday+","+cost+"\n");//
    ...
    public static void main(String[]args){
        new coxePay(new Login(), new CustomerInfo(new Login()), new pPack(new Login(), new CustomerInfo(new Login())),new coxe(new Login(), new CustomerInfo(new Login()), new pPack(new Login(), new CustomerInfo(new Login()))));
    }
}
