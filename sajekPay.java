...
public class sajekPay extends JFrame implements ActionListener{
	...
	private sajek sajek_obj;

    public sajek get_pack_obj(){
        return sajek_obj;
    }

    public sajekPay(Login login_Obj, CustomerInfo CustomerInfo_obj,pPack pPack_obj,sajek sajek_obj){
        super("PAYMENT");
		this.login_Obj=login_Obj;
		this.CustomerInfo_obj=CustomerInfo_obj;
		this.pPack_obj=pPack_obj;
		this.sajek_obj=sajek_obj;
            ...
            if(rbt1.isSelected()==true){
                if(!nc.isEmpty()&&!cn.isEmpty()&&!vo.isEmpty()&&!cvv.isEmpty()){
                    ...
                    try{
                        ...
                        writer.write(email+","+"Sajek"+","+date+","+person+","+hotel+","+day+",2,"+room+","+vehicle+","+payday+","+cost+"\n");//
    ...
    public static void main(String[]args){
        new sajekPay(new Login(), new CustomerInfo(new Login()), new pPack(new Login(), new CustomerInfo(new Login())),new sajek(new Login(), new CustomerInfo(new Login()), new pPack(new Login(), new CustomerInfo(new Login()))));
    }
}
