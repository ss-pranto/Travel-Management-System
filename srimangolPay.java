...
public class srimangolPay extends JFrame implements ActionListener{
    ...
    public srimangol get_pack_obj(){
        return srimangol_obj;
    }

    public srimangolPay(Login login_Obj, CustomerInfo CustomerInfo_obj,pPack pPack_obj,srimangol srimangol_obj){
        super("PAYMENT");
		
		this.login_Obj=login_Obj;
		this.CustomerInfo_obj=CustomerInfo_obj;
		this.pPack_obj=pPack_obj;
		this.srimangol_obj=srimangol_obj;
            ...
            if(rbt1.isSelected()==true){
                if(!nc.isEmpty()&&!cn.isEmpty()&&!vo.isEmpty()&&!cvv.isEmpty()){
                    ...
                    try{
                        ...
                        writer.write(email+","+"Srimangol"+","+date+","+person+","+hotel+","+day+",2,"+room+","+vehicle+","+payday+","+cost+"\n");//
    ...
    public static void main(String[]args){
        new srimangolPay(new Login(), new CustomerInfo(new Login()), new pPack(new Login(), new CustomerInfo(new Login())),new srimangol(new Login(), new CustomerInfo(new Login()), new pPack(new Login(), new CustomerInfo(new Login()))));
    }
}
